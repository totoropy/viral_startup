    ...
    'action'=>Yii::app()->createUrl('ajax/mail'),
		...
		<table style="border:0px;margin-bottom: 10px;">
			...
			<tr>
				...
				<td class="data"><div id="mail-box-body" class=""><textarea id="MailForm_body" class="uiTextareaAutogrow" rows="5" cols="35" style="width:320px;height:80px" name="MailForm[body]">Ahoj, účastním se foto soutěže KEEN LOGO. Hlasuj pro mě. Dík.
